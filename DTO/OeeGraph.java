...
public OeeGraph(String machineNumber, String usedKg, String goodKg,
...
public void setNovisYieldActual(double novisYieldActual) {
	this.novisYieldActual = novisYieldActual;
}
...
public void setUtilizationActual(double utilizationActual) {
	this.utilizationActual = utilizationActual;
}
...
public void setGlassYieldActual(double glassYieldActual) {
	this.glassYieldActual = glassYieldActual;
}
...
public void setOaeActual(double oaeActual) {
	this.oaeActual = oaeActual;
}
public double getOaeTarget() {
	return oaeTarget;
}
public void setOaeTarget(double oaeTarget) {
	this.oaeTarget = (getGlassYieldTarget()*getUtilizationTarget()*getPerformanceTarget()*getLoadingTarget())/10000;
}
